...
var input_number_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const handleBlur = (event) => {
      var _a, _b, _c;
      data.userInput = null;
      if (data.currentValue === null && ((_a = input.value) == null ? void 0 : _a.input)) input.value.input.value = ((_b = props.formatter) == null ? void 0 : _b.call(props, "")) ?? "";
      emit("blur", event);
      if (props.validateEvent) (_c = formItem == null ? void 0 : formItem.validate) == null ? void 0 : _c.call(formItem, "blur").catch(NOOP);
    };
    ...
    onUpdated(() => {
      var _a, _b;
      (_b = (_a = input.value) == null ? void 0 : _a.input) == null ? void 0 : _b.setAttribute("aria-valuenow", `${data.currentValue ?? ""}`);
    });
    __expose({
...
export {
  ElInputNumber,
  ElInputNumber as default,
  inputNumberEmits,
  inputNumberProps
};
//# sourceMappingURL=element-plus_es_components_input-number_index__mjs.js.map
