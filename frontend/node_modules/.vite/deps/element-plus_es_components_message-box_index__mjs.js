...
} from "./chunk-TX3MSJHZ.js";
import "./chunk-EIX34RHL.js";
import {
  ElButton
...
import "./chunk-PBFNIJWU.js";
import "./chunk-M42ETLC4.js";
import "./chunk-3AGLNHFM.js";
import {
  debugWarn,
  isClient,
  isElement,
...
var index_vue_vue_type_script_lang_default = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    watch(() => visible.value, (val) => {
      var _a;
      if (val) {
        if (props.boxType !== "prompt") if (state.autofocus) focusStartRef.value = ((_a = confirmRef.value) == null ? void 0 : _a.$el) ?? rootRef.value;
    ...
    const handleWrapperClick = () => {
      if (props.closeOnClickModal) handleAction2(state.distinguishCancelAndClose ? "close" : "cancel");
    };
    ...
    const getInputElement = () => {
      ...
      return (inputRefs == null ? void 0 : inputRefs.input) ?? (inputRefs == null ? void 0 : inputRefs.textarea);
    };
    const handleClose = () => {
      handleAction2("close");
    };
...
var src_default = _plugin_vue_export_helper_default(index_vue_vue_type_script_lang_default, [["render", _sfc_render]]);
...
var initInstance = (props, container, appContext = null) => {
  const vnode = createVNode(src_default, props, isFunction(props.message) || isVNode(props.message) ? { default: isFunction(props.message) ? () => props.message({
...
export {
  ElMessageBox,
  _MessageBox as default
};
//# sourceMappingURL=element-plus_es_components_message-box_index__mjs.js.map
