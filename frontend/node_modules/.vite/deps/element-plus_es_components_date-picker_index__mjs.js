import {
  datePickTypes
} from "./chunk-EIX34RHL.js";
import {
  ElButton
} from "./chunk-2AWQ3IG5.js";
import {
  ClickOutside
} from "./chunk-4ZLXMOOO.js";
import {
  Ee,
  ElScrollbar,
  ElTooltip,
  useTooltipContentProps
} from "./chunk-QFMVGNUW.js";
import {
  castArray,
  extractFirst
} from "./chunk-BDF6O2LW.js";
import "./chunk-LUEOE7LA.js";
import "./chunk-OTSBSD37.js";
import "./chunk-H4JG26WD.js";
import {
  useEmptyValues,
  useEmptyValuesProps
} from "./chunk-F7BBRY26.js";
import "./chunk-IW5YT2MQ.js";
import "./chunk-ABFOVNWO.js";
import {
  vRepeatClick
} from "./chunk-54CZT3J2.js";
import {
  ElInput
} from "./chunk-PQDTILVU.js";
import {
  useFocusController
} from "./chunk-NJGK4LJW.js";
import {
  useAriaProps
} from "./chunk-PKGMUE7G.js";
import {
  useFormItem,
  useFormItemInputId
} from "./chunk-24WVPKBS.js";
import {
  useFormDisabled,
  useFormSize
} from "./chunk-D4SZUGIY.js";
import {
  CHANGE_EVENT,
  UPDATE_MODEL_EVENT
} from "./chunk-O5LXM7SF.js";
import "./chunk-YRJBH3MA.js";
import "./chunk-GQM4ASRC.js";
import {
  useSizeProp
} from "./chunk-N4HJKOBW.js";
import {
  useAttrs as useAttrs2
} from "./chunk-GUKQNH3A.js";
import "./chunk-VHB577RR.js";
import {
  rAF
} from "./chunk-3HFGK3DP.js";
import {
  EVENT_CODE,
  getEventCode
} from "./chunk-QLQF6BX6.js";
import {
  ElIcon
} from "./chunk-PKAPS67G.js";
import {
  getStyle,
  hasClass
} from "./chunk-4FWGJVY3.js";
import {
  useLocale
} from "./chunk-PBFNIJWU.js";
import "./chunk-M42ETLC4.js";
import {
  withInstall
} from "./chunk-3AGLNHFM.js";
import {
  buildProps,
  debounce_default,
  definePropType,
...
var makeList = (total, method) => {
  ...
  for (let i = 0; i < total; i++) arr.push((disabledArr == null ? void 0 : disabledArr.includes(i)) ?? false);
  return arr;
};
...
var picker_range_trigger_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { isFocused, handleFocus, handleBlur } = useFocusController(inputRef, {
      ...
      afterBlur() {
        ...
        if (isTimePicker.value && !props.saveOnBlur) {
          if (!valueIsEmpty.value) (_b = (_a = pickerOptions.value).handleCancel) == null ? void 0 : _b.call(_a);
        } else handleChange();
        pickerVisible.value = false;
        hasJustTabExitedInput = false;
        props.validateEvent && (formItem == null ? void 0 : formItem.validate("blur").catch(NOOP));
      }
    });
    ...
    const emitChange = (val, isClear) => {
      if (isClear || !valueEquals(val, valueOnOpen.value)) {
        ...
        props.validateEvent && (formItem == null ? void 0 : formItem.validate("change").catch(NOOP));
      }
    };
    const emitKeydown = (e) => {
      emit("keydown", e);
    ...
    const onMouseDownInput = async (event) => {
      var _a;
      if (props.readonly || pickerDisabled.value) return;
      if (((_a = event.target) == null ? void 0 : _a.tagName) !== "INPUT" || isFocused.value || !props.automaticDropdown) pickerVisible.value = true;
    };
    const onMouseEnter = () => {
      if (props.readonly || pickerDisabled.value) return;
    ...
    const onTouchStartInput = (event) => {
      var _a;
      if (props.readonly || pickerDisabled.value) return;
      if (((_a = event.touches[0].target) == null ? void 0 : _a.tagName) !== "INPUT" || isFocused.value || !props.automaticDropdown) pickerVisible.value = true;
    };
...
var basic_time_spinner_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const typeItemHeight = (type) => {
      var _a;
      const listItem = (_a = unref(listRefsMap[type])) == null ? void 0 : _a.$el.querySelector("li");
    ...
    const handleScroll = (type) => {
      ...
      modifyDateField(type, Math.min(Math.round((getScrollbarElement(scrollbar.$el).scrollTop - (scrollBarHeight(type) * 0.5 - 10) / typeItemHeight(type) + 3) / typeItemHeight(type)), type === "hours" ? 23 : 59));
    };
      ...
      return openBlock(), createElementBlock("div", { class: normalizeClass([unref(ns).b("spinner"), { "has-seconds": _ctx.showSeconds }]) }, [!_ctx.arrowControl ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(spinnerItems.value, (item) => {
        return openBlock(), createBlock(unref(ElScrollbar), {
          ...
          default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(timeList.value[item], (disabled, key) => {
            ...
            }, [item === "hours" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(("0" + (_ctx.amPmMode ? key % 12 || 12 : key)).slice(-2)) + toDisplayString(getAmPmFlag(key)), 1)], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(("0" + key).slice(-2)), 1)], 64))], 10, _hoisted_12);
          }), 128))]),
          _: 2
        }, 1032, [
          "class",
...
var isValidRange = (range) => {
  ...
  const [left, right] = range;
  return import_dayjs3.default.isDayjs(left) && import_dayjs3.default.isDayjs(right) && (0, import_dayjs3.default)(left).isValid() && (0, import_dayjs3.default)(right).isValid() && left.isSameOrBefore(right);
};
var getDefaultValue = (defaultValue, { lang, step: step2 = 1, unit: unit4, unlinkPanels }) => {
  let start;
  if (isArray(defaultValue)) {
    let [left, right] = defaultValue.map((d) => (0, import_dayjs3.default)(d).locale(lang));
    if (!unlinkPanels) right = left.add(step2, unit4);
    return [left, right];
  } else if (defaultValue) start = (0, import_dayjs3.default)(defaultValue);
  else start = (0, import_dayjs3.default)();
...
var buildPickerTable = (dimension, rows, { columnIndexOffset, startDate, nextEndDate, now, unit: unit4, relativeDateGetter, setCellMetadata, setRowMetadata }) => {
  for (let rowIndex = 0; rowIndex < dimension.row; rowIndex++) {
    ...
    for (let columnIndex = 0; columnIndex < dimension.column; columnIndex++) {
      ...
      if (nextStartDate.isSame(now, unit4)) cell.type = "today";
...
var datesInMonth = (date, year, month, lang) => {
  const firstDay = (0, import_dayjs3.default)().locale(lang).startOf("month").month(month).year(year).hour(date.hour()).minute(date.minute()).second(date.second());
...
var getValidDateOfMonth = (date, year, month, lang, disabledDate) => {
  const _value = (0, import_dayjs3.default)().year(year).month(month).startOf("month").hour(date.hour()).minute(date.minute()).second(date.second());
  const _date = datesInMonth(date, year, month, lang).find((date2) => {
    return !(disabledDate == null ? void 0 : disabledDate(date2));
  });
  if (_date) return (0, import_dayjs3.default)(_date).locale(lang);
  return _value.locale(lang);
};
var getValidDateOfYear = (value, lang, disabledDate) => {
  const year = value.year();
  if (!(disabledDate == null ? void 0 : disabledDate(value.toDate()))) return value.locale(lang);
...
var correctlyParseUserInput = (value, format, lang, defaultFormat) => {
  ...
  if (isString(value)) {
    const dayjsValue = (defaultFormat == null ? void 0 : defaultFormat.value) ? (0, import_dayjs3.default)(value) : (0, import_dayjs3.default)(value, format);
    if (!dayjsValue.isValid()) return dayjsValue;
  }
  return (0, import_dayjs3.default)(value, format).locale(lang);
};
...
var useBasicDateTable = (props, emit) => {
  ...
  const rows = computed(() => {
    ...
    buildPickerTable({
      ...
      now: (0, import_dayjs4.default)().locale(unref(lang)).startOf(dateUnit),
      unit: dateUnit,
  ...
  const cellMatchesDate = (cell, date) => {
    ...
    return (0, import_dayjs4.default)(date).locale(unref(lang)).isSame(props.date.date(Number(cell.text)), "day");
  };
...
var basic_cell_render_default = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      const { cell } = props;
      return renderSlot(slots, "default", { ...cell }, () => [createVNode("div", { "class": ns.b() }, [createVNode("span", { "class": ns.e("text") }, [(cell == null ? void 0 : cell.renderText) ?? (cell == null ? void 0 : cell.text)])])]);
    };
  }
});
...
var basic_date_table_vue_vue_type_script_setup_true_lang_default = defineComponent({
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("table", {
        ...
        return openBlock(), createElementBlock("th", {
          ...
          scope: "col"
        }, toDisplayString(unref(t)("el.datepicker.weeks." + week)), 9, _hoisted_23);
...
var basic_month_table_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const rows = computed(() => {
      ...
      const now = (0, import_dayjs5.default)().locale(lang.value).startOf("month");
      for (let i = 0; i < 3; i++) {
        const row = rows2[i];
        for (let j = 0; j < 4; j++) {
    ...
    const getCellStyle = (cell) => {
      ...
      style.current = castArray(props.parsedValue).some((date) => import_dayjs5.default.isDayjs(date) && date.year() === year && date.month() === month);
    ...
    const handleMonthTableClick = (event) => {
      ...
      if (props.selectionMode === "months") {
        ...
        emit("pick", hasClass(target, "current") ? castArray(props.parsedValue).filter((d) => (d == null ? void 0 : d.year()) !== newMonth.year() || (d == null ? void 0 : d.month()) !== newMonth.month()) : castArray(props.parsedValue).concat([(0, import_dayjs5.default)(newMonth)]));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("table", {
        ...
        return openBlock(), createElementBlock("tr", { key }, [(openBlock(true), createElementBlock(Fragment, null, renderList(row, (cell, key_) => {
          ...
          } }, null, 8, ["cell"])], 42, _hoisted_24);
        }), 128))]);
      }), 128))], 512)], 42, _hoisted_14);
    };
  }
});
...
var basic_year_table_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const datesInYear = (year, lang2) => {
      const firstDay = (0, import_dayjs6.default)(String(year)).locale(lang2).startOf("year");
    ...
    const rows = computed(() => {
      var _a, _b, _c;
      const rows2 = tableRows.value;
      const now = (0, import_dayjs6.default)().locale(lang.value).startOf("year");
      for (let i = 0; i < 3; i++) {
        const row = rows2[i];
        for (let j = 0; j < 4; j++) {
          if (i * 4 + j >= 10) break;
          ...
          const calTime = (0, import_dayjs6.default)().year(index);
          const calEndDate = props.rangeState.endDate || props.maxDate || props.rangeState.selecting && props.minDate || null;
    ...
    const getCellKls = (cell) => {
      const kls = {};
      const today = (0, import_dayjs6.default)().locale(lang.value);
    ...
    const handleYearTableClick = (event) => {
      ...
      const newDate = (0, import_dayjs6.default)().year(selectedYear);
      if (props.selectionMode === "range") if (!props.rangeState.selecting) {
        ...
        emit("pick", hasClass(target, "current") ? castArray(props.parsedValue).filter((d) => (d == null ? void 0 : d.year()) !== selectedYear) : castArray(props.parsedValue).concat([vaildYear]));
    ...
    const handleMouseMove = (event) => {
      ...
      if (row !== lastRow.value || column !== lastColumn.value) {
        ...
        emit("changerange", {
          selecting: true,
          endDate: (0, import_dayjs6.default)().year(startYear.value).add(row * 4 + column, "year")
        });
      }
    };
    watch(() => props.date, async () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("table", {
        ...
        return openBlock(), createElementBlock("tr", { key: rowKey }, [(openBlock(true), createElementBlock(Fragment, null, renderList(row, (cell, cellKey) => {
          ...
          }, [createVNode(unref(basic_cell_render_default), { cell }, null, 8, ["cell"])], 42, _hoisted_25);
        }), 128))]);
      }), 128))], 512)], 42, _hoisted_15);
    };
  }
});
...
var _hoisted_26 = ["aria-label", "disabled"];
var _hoisted_32 = ["aria-label", "disabled"];
var _hoisted_4 = ["tabindex", "aria-disabled"];
var _hoisted_5 = ["tabindex", "aria-disabled"];
var _hoisted_6 = ["aria-label", "disabled"];
var _hoisted_7 = ["aria-label", "disabled"];
var panel_date_pick_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const innerDate = ref((0, import_dayjs7.default)().locale(lang.value));
    const isChangeToNow = ref(false);
    let isShortcut = false;
    const defaultTimeD = computed(() => {
      return (0, import_dayjs7.default)(defaultTime).locale(lang.value);
    });
    ...
    const handleDatePick = async (value, keepOpen) => {
      if (selectionMode.value === "date" && import_dayjs7.default.isDayjs(value)) {
    ...
    const handleShortcutClick = (shortcut) => {
      ...
      if (shortcutValue) {
        isShortcut = true;
        emit((0, import_dayjs7.default)(shortcutValue).locale(lang.value));
        return;
      }
    ...
    const onConfirm = () => {
      if (isMultipleType.value) emit(props.parsedValue);
        ...
        if (!result) {
          const defaultTimeD2 = (0, import_dayjs7.default)(defaultTime).locale(lang.value);
    ...
    const disabledNow = computed(() => {
      if (!disabledDate) return false;
      return disabledDate((0, import_dayjs7.default)().locale(lang.value).toDate());
    });
    const changeToNow = () => {
      const nowDate = (0, import_dayjs7.default)().locale(lang.value).toDate();
      isChangeToNow.value = true;
      if ((!disabledDate || !disabledDate(nowDate)) && checkDateWithinRange(nowDate)) {
        innerDate.value = (0, import_dayjs7.default)().locale(lang.value);
    ...
    const handleVisibleTimeChange = (value) => {
      const newDate = (0, import_dayjs7.default)(value, timeFormat.value).locale(lang.value);
    ...
    const isValidValue = (date) => {
      return import_dayjs7.default.isDayjs(date) && date.isValid() && (disabledDate ? !disabledDate(date.toDate()) : true);
    };
    const parseUserInput = (value) => {
      return correctlyParseUserInput(value, props.format, lang.value, isDefaultFormat);
    };
    const getDefaultValue2 = () => {
      const parseDate2 = (0, import_dayjs7.default)(defaultValue.value).locale(lang.value);
      if (!defaultValue.value) {
        const defaultTimeDValue = defaultTimeD.value;
        return (0, import_dayjs7.default)().hour(defaultTimeDValue.hour()).minute(defaultTimeDValue.minute()).second(defaultTimeDValue.second()).locale(lang.value);
      }
      return parseDate2;
    };
    const handleFocusPicker = () => {
      ...
      if ([
        ...
        "year",
        "date"
      ].includes(selectionMode.value)) (_a = currentViewRef.value) == null ? void 0 : _a.focus();
    };
    ...
    const handleKeyControl = (code) => {
      ...
      while (Math.abs(innerDate.value.diff(newDate, "year", true)) < 1) {
        ...
        const result = (0, import_dayjs7.default)(newDate).locale(lang.value);
        innerDate.value = result;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", { class: normalizeClass([
        ...
        hasShortcuts.value ? (openBlock(), createElementBlock("div", {
          ...
          }, toDisplayString(shortcut.text), 11, _hoisted_16);
        ...
        createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body")) }, [
          ...
          withDirectives(createBaseVNode("div", { class: normalizeClass([unref(dpNs).e("header"), (currentView.value === "year" || currentView.value === "month") && unref(dpNs).em("header", "bordered")]) }, [
            createBaseVNode("span", { class: normalizeClass(unref(dpNs).e("prev-btn")) }, [createBaseVNode("button", {
              ...
              _: 1
            })])], 10, _hoisted_26), withDirectives(createBaseVNode("button", {
              type: "button",
              ...
              _: 1
            })])], 10, _hoisted_32), [[vShow, currentView.value === "date"]])], 2),
            ...
            createBaseVNode("span", { class: normalizeClass(unref(dpNs).e("next-btn")) }, [withDirectives(createBaseVNode("button", {
              ...
              _: 1
            })])], 10, _hoisted_6), [[vShow, currentView.value === "date"]]), createBaseVNode("button", {
              type: "button",
...
var useShortcut = (lang) => {
  ...
  const handleShortcutClick = (shortcut) => {
    ...
    if (shortcutValues) {
      emit("pick", [(0, import_dayjs8.default)(shortcutValues[0]).locale(lang.value), (0, import_dayjs8.default)(shortcutValues[1]).locale(lang.value)]);
      return;
    }
    if (shortcut.onClick) shortcut.onClick({
      attrs,
...
var useRangePicker = (props, { defaultValue, defaultTime, leftDate, rightDate, step: step2, unit: unit4, sortDates }) => {
  const { emit } = getCurrentInstance();
  ...
  const restoreDefault = () => {
    ...
    if (maybeTimes) {
      ...
      if (isArray(maybeTimes)) {
        const [timeStart, timeEnd] = maybeTimes.map(import_dayjs9.default);
        leftShift = getShift(timeStart);
        rightShift = getShift(timeEnd);
      } else {
        const shift = getShift((0, import_dayjs9.default)(maybeTimes));
        leftShift = shift;
        rightShift = shift;
      }
  ...
  watch(() => props.parsedValue, (parsedValue) => {
    if (!(parsedValue == null ? void 0 : parsedValue.length) || !isEqual_default(parsedValue, [minDate.value, maxDate.value])) parseValue(parsedValue);
  }, { immediate: true });
  watch(() => props.visible, () => {
...
var _hoisted_33 = ["aria-label", "disabled"];
var _hoisted_42 = ["disabled", "aria-label"];
var _hoisted_52 = ["disabled", "aria-label"];
var _hoisted_62 = ["tabindex", "aria-disabled"];
var _hoisted_72 = ["tabindex", "aria-disabled"];
...
var _hoisted_122 = ["tabindex", "aria-disabled"];
var _hoisted_132 = ["tabindex", "aria-disabled"];
var unit = "month";
var panel_date_range_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const rightDate = ref((0, import_dayjs10.default)().locale(lang.value).add(1, unit));
    ...
    const formatEmit = (emitDayjs, index) => {
      if (!emitDayjs) return;
      if (defaultTime) return (0, import_dayjs10.default)(defaultTime[index] || defaultTime).locale(lang.value).year(emitDayjs.year()).month(emitDayjs.month()).date(emitDayjs.date());
      return emitDayjs;
    };
    ...
    const handleDateInput = (value, type) => {
      ...
      const parsedValueD = (0, import_dayjs10.default)(value, dateFormat.value).locale(lang.value);
    ...
    const handleTimeInput = (value, type) => {
      ...
      const parsedValueD = (0, import_dayjs10.default)(value, timeFormat.value).locale(lang.value);
    ...
    const handleClear = () => {
      ...
      if (pickerBase == null ? void 0 : pickerBase.emptyValues) valueOnClear = pickerBase.emptyValues.valueOnClear.value;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", { class: normalizeClass([
        ...
        hasShortcuts.value ? (openBlock(), createElementBlock("div", {
          ...
          }, toDisplayString(shortcut.text), 11, _hoisted_17);
        }), 128))], 2)) : createCommentVNode("v-if", true),
        createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body")) }, [
          showTime.value ? (openBlock(), createElementBlock("div", {
            key: 0,
          ...
          createBaseVNode("div", { class: normalizeClass([
            ...
            createBaseVNode("div", { class: normalizeClass(unref(drpNs).e("header")) }, [
              ...
              withDirectives(createBaseVNode("button", {
                ...
                default: withCtx(() => [createVNode(unref(arrow_left_default))]),
                _: 1
              })])], 10, _hoisted_33), [[vShow, unref(leftCurrentView) === "date"]]),
              _ctx.unlinkPanels || _ctx.singlePanel ? (openBlock(), createElementBlock("button", {
                ...
                default: withCtx(() => [createVNode(unref(d_arrow_right_default))]),
                _: 1
              })])], 10, _hoisted_42)) : createCommentVNode("v-if", true),
              ...
              }, toDisplayString(unref(leftYearLabel)), 43, _hoisted_62), withDirectives(createBaseVNode("span", {
                role: "button",
                "aria-live": "polite",
                tabindex: _ctx.disabled ? void 0 : 0,
                "aria-disabled": _ctx.disabled,
              ...
              }, toDisplayString(unref(t)(`el.datepicker.month${leftDate.value.month() + 1}`)), 43, _hoisted_72), [[vShow, unref(leftCurrentView) === "date"]])])
            ], 2),
          ...
          !_ctx.singlePanel ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", { class: normalizeClass(unref(drpNs).e("header")) }, [
              ...
              }, toDisplayString(unref(rightYearLabel)), 43, _hoisted_122), withDirectives(createBaseVNode("span", {
                role: "button",
                "aria-live": "polite",
                tabindex: _ctx.disabled ? void 0 : 0,
                "aria-disabled": _ctx.disabled,
              ...
              }, toDisplayString(unref(t)(`el.datepicker.month${rightDate.value.month() + 1}`)), 43, _hoisted_132), [[vShow, unref(rightCurrentView) === "date"]])])
            ], 2),
...
var unit2 = "year";
var panel_month_range_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const rightDate = ref((0, import_dayjs11.default)().locale(lang.value).add(1, unit2));
    ...
    function sortDates(minDate2, maxDate2) {
      if (props.unlinkPanels && maxDate2) rightDate.value = ((minDate2 == null ? void 0 : minDate2.year()) || 0) === maxDate2.year() ? maxDate2.add(1, unit2) : maxDate2;
      else rightDate.value = leftDate.value.add(1, unit2);
    }
      ...
      return openBlock(), createElementBlock("div", { class: normalizeClass([
        ...
        hasShortcuts.value ? (openBlock(), createElementBlock("div", {
          ...
          return openBlock(), createElementBlock("button", {
            ...
            onClick: ($event) => unref(handleShortcutClick)(shortcut)
          }, toDisplayString(shortcut.text), 11, _hoisted_18);
        }), 128))], 2)) : createCommentVNode("v-if", true),
        createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body")) }, [createBaseVNode("div", { class: normalizeClass([
          ...
          _ctx.unlinkPanels || _ctx.singlePanel ? (openBlock(), createElementBlock("button", {
            ...
            default: withCtx(() => [createVNode(unref(d_arrow_right_default))]),
            _: 1
          })])], 10, _hoisted_34)) : createCommentVNode("v-if", true),
          ...
          _ctx.unlinkPanels ? (openBlock(), createElementBlock("button", {
            ...
            default: withCtx(() => [createVNode(unref(d_arrow_left_default))]),
            _: 1
          })])], 10, _hoisted_43)) : createCommentVNode("v-if", true),
          createBaseVNode("button", {
            type: "button",
            class: normalizeClass([unref(ppNs).e("icon-btn"), "d-arrow-right"]),
            disabled: unref(monthRangeDisabled),
...
var step = 10;
var unit3 = "year";
var panel_year_range_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const rightDate = ref((0, import_dayjs12.default)().locale(lang.value).add(step, unit3));
    const isDefaultFormat = inject(ROOT_PICKER_IS_DEFAULT_FORMAT_INJECTION_KEY, void 0);
    const pickerBase = inject(PICKER_BASE_INJECTION_KEY);
    const { shortcuts, disabledDate, cellClassName } = pickerBase.props;
    const format = toRef(pickerBase.props, "format");
    ...
    function sortDates(minDate2, maxDate2) {
      ...
      } else rightDate.value = leftDate.value.add(step, unit3);
    }
    watch(() => props.visible, (visible) => {
      if (!visible && rangeState.value.selecting) {
        parseValue(props.parsedValue);
      ...
      return openBlock(), createElementBlock("div", { class: normalizeClass(panelKls.value) }, [createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body-wrapper")) }, [
        ...
        hasShortcuts.value ? (openBlock(), createElementBlock("div", {
          ...
          return openBlock(), createElementBlock("button", {
            ...
            onClick: ($event) => unref(handleShortcutClick)(shortcut)
          }, toDisplayString(shortcut.text), 11, _hoisted_19);
        }), 128))], 2)) : createCommentVNode("v-if", true),
        createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body")) }, [createBaseVNode("div", { class: normalizeClass(leftPanelKls.value.content) }, [createBaseVNode("div", { class: normalizeClass(unref(drpNs).e("header")) }, [
          ...
          _ctx.unlinkPanels || _ctx.singlePanel ? (openBlock(), createElementBlock("button", {
            ...
            default: withCtx(() => [createVNode(unref(d_arrow_right_default))]),
            _: 1
          })])], 10, _hoisted_35)) : createCommentVNode("v-if", true),
          createBaseVNode("div", null, toDisplayString(unref(leftLabel)), 1)
...
import_dayjs13.default.extend(import_localeData.default);
import_dayjs13.default.extend(import_advancedFormat.default);
import_dayjs13.default.extend(import_customParseFormat.default);
...
var date_picker_panel_default = defineComponent({
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    return () => {
      return createVNode(getPanel(props.type), mergeProps(omit_default(attrs, "onPick"), props, {
    ...
    return () => {
      return createVNode(picker_default, mergeProps(props, {
        ...
        default: (scopedProps) => createVNode(ElDatePickerPanel, mergeProps({
          ...
          "border": false
        }, scopedProps), _isSlot2(slots) ? slots : { default: () => [slots] }),
...
export {
  ElDatePicker,
  datePickerProps,
  ElDatePicker as default
};
//# sourceMappingURL=element-plus_es_components_date-picker_index__mjs.js.map
