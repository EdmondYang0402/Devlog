...
var rt = "write";
var ot = "afterWrite";
var it = [Je, Ke, Qe, Ze, et, tt, nt, rt, ot];
function V(e) {
...
var We = { name: "computeStyles", enabled: true, phase: "beforeWrite", fn: Ft, data: {} };
var ge = { passive: true };
function Ut(e) {
...
var popperCoreConfigPropsDefaults = {
  boundariesPadding: 0,
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ElPopper), {
        ...
        default: withCtx(() => [createVNode(trigger_default2, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        "aria-label",
        "aria-orientation"
      ]))], 46, _hoisted_12), !__props.native ? (openBlock(), createBlock(bar_default, {
        key: 0,
        ref_key: "barRef",
        ref: barRef,
        always: __props.always,
...
//# sourceMappingURL=chunk-3LVYDCJO.js.map
