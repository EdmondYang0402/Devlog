...
var uploadContentPropsDefaults = {
  ...uploadBasePropsDefaults,
  beforeUpload: NOOP,
  onRemove: NOOP,
  onStart: NOOP,
...
var progress_vue_vue_type_script_setup_true_lang_default = defineComponent({
  name: "ElProgress",
  __name: "progress",
  props: progressProps,
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, [renderSlot(_ctx.$slots, "default", { percentage: __props.percentage }, () => [createBaseVNode("span", null, toDisplayString(content.value), 1)])], 2)) : createCommentVNode("v-if", true)], 6)], 6)], 2)) : (openBlock(), createElementBlock("div", {
        key: 1,
      ...
      }, [(openBlock(), createElementBlock("svg", _hoisted_2, [createBaseVNode("path", {
      ...
      }, null, 14, _hoisted_3), createBaseVNode("path", {
...
var _hoisted_22 = ["src", "crossorigin"];
var _hoisted_32 = ["onClick"];
var _hoisted_42 = ["title"];
var _hoisted_52 = ["onClick"];
var _hoisted_6 = ["onClick"];
var upload_list_vue_vue_type_script_setup_true_lang_default = defineComponent({
  name: "ElUploadList",
  __name: "upload-list",
        ...
        default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.files, (file, index) => {
          return openBlock(), createElementBlock("li", {
            ...
            __props.listType === "picture" || file.status !== "uploading" && __props.listType === "picture-card" ? (openBlock(), createElementBlock("img", {
              ...
              alt: ""
            }, null, 10, _hoisted_22)) : createCommentVNode("v-if", true),
            file.status === "uploading" || __props.listType !== "picture-card" ? (openBlock(), createElementBlock("div", {
              ...
              title: file.name
            }, toDisplayString(file.name), 11, _hoisted_42)], 10, _hoisted_32), file.status === "uploading" ? (openBlock(), createBlock(unref(ElProgress), {
              key: 0,
            ...
            createBaseVNode("label", { class: normalizeClass(unref(nsUpload).be("list", "item-status-label")) }, [__props.listType === "text" ? (openBlock(), createBlock(unref(ElIcon), {
              key: 0,
            ...
            __props.listType === "picture-card" ? (openBlock(), createElementBlock("span", {
              ...
              _: 1
            }, 8, ["class"])], 10, _hoisted_52), !unref(disabled) ? (openBlock(), createElementBlock("span", {
              key: 0,
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getAllFiles = async (entry) => {
      try {
        ...
        if (entry.isDirectory) {
          ...
          return flatten_default(await Promise.all(filePromises));
        }
      } catch {
        return [];
      }
    ...
    const onDrop = async (e) => {
      ...
      if (props.directory) {
        ...
        emit("file", flatten_default(await Promise.all(entries.map(getAllFiles))));
        return;
      }
...
var upload_content_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _: 3
      }, 8, ["disabled", "directory"])) : renderSlot(_ctx.$slots, "default", { key: 1 }), createBaseVNode("input", {
        ref_key: "inputRef",
        ref: inputRef,
      ...
      }, null, 42, _hoisted_23)], 42, _hoisted_13);
    };
  }
});
...
var useHandlers = (props, uploadRef) => {
  ...
  const handleRemove = async (file) => {
    ...
    if (!uploadFile) throwError(SCOPE2, "file to be removed not found");
...
var upload_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const { abort, submit, clearFiles, uploadFiles, handleStart, handleError, handleRemove, handleSuccess, handleProgress, revokeFileObjectURL: revokeFileObjectURL2 } = useHandlers(props, uploadRef);
...
//# sourceMappingURL=element-plus_es_components_upload_index__mjs.js.map
