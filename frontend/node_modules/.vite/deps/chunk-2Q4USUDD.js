...
var END_REACHED_EVT = "end-reached";
var FORWARD = "forward";
...
// node_modules/element-plus/es/components/tabs/src/composables/use-tab-nav-touch.mjs
...
var useTabNavTouch = ({ scrollable, navOffset, navSize, navContainerSize, isHorizontal }) => {
  ...
  const handleTouchMove = (event) => {
    ...
    if (isUndefined_default(isMainAxisTouch)) {
    ...
    const nextOffset = clamp_default(touchState.startOffset + mainAxisDelta, 0, maxOffset.value);
...
var TabNav = defineComponent({
  ...
  setup(props, { expose, emit }) {
    const rootTabs = inject(tabsRootContextKey);
    if (!rootTabs) throwError(COMPONENT_NAME2, `<el-tabs><tab-nav /></el-tabs>`);
    const ns = useNamespace("tabs");
    ...
    const { onWheel } = useWheel({
      ...
      navOffset.value = clamp_default(navOffset.value + offset, 0, navSize.value - navContainerSize.value);
    });
    ...
    const focusActiveTab = async () => {
      var _a;
      await nextTick();
      (_a = tabRefsMap.value[props.currentName]) == null ? void 0 : _a.focus({ preventScroll: true });
    };
  ...
  setup(props, { emit, slots, expose }) {
    ...
    const setCurrentName = async (value, trigger = false) => {
      ...
      try {
        ...
        if (canLeave !== false) {
          const isFocusInsidePane = (_a = panes.value.find((item) => item.paneName === currentName.value)) == null ? void 0 : _a.isFocusInsidePane();
          ...
          if (isFocusInsidePane) (_d = nav$.value) == null ? void 0 : _d.focusActiveTab();
        }
      } catch {
      }
    };
...
var COMPONENT_NAME3 = "ElTabPane";
var tab_pane_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props) {
    ...
    if (!tabsRoot) throwError(COMPONENT_NAME3, "usage: <el-tabs><el-tab-pane /></el-tabs/>");
...
//# sourceMappingURL=chunk-2Q4USUDD.js.map
