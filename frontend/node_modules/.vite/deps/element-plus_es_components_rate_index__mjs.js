...
var rate_vue_vue_type_script_setup_true_lang_default = defineComponent({
  name: "ElRate",
  __name: "rate",
  props: rateProps,
  emits: rateEmits,
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const currentValue = ref(clamp_default(props.modelValue, 0, props.max));
    ...
    function resetCurrentValue() {
      ...
      currentValue.value = clamp_default(props.modelValue, 0, props.max);
      hoverIndex.value = -1;
    }
    watch(() => props.modelValue, (val) => {
      currentValue.value = clamp_default(val, 0, props.max);
...
//# sourceMappingURL=element-plus_es_components_rate_index__mjs.js.map
