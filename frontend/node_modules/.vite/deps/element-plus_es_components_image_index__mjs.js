import {
  useLockscreen
} from "./chunk-OVT6BED5.js";
import {
  getScrollContainer
} from "./chunk-6XTQJOQ4.js";
import {
  focus_trap_default$1
} from "./chunk-IW5YT2MQ.js";
import {
  useZIndex
} from "./chunk-ABFOVNWO.js";
import {
...
var _hoisted_1 = ["src", "crossorigin"];
var image_viewer_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    watch(currentImg, () => {
      nextTick(() => {
        var _a;
        if (!((_a = imgRef.value) == null ? void 0 : _a.complete)) loading.value = true;
      });
    });
      ...
      return openBlock(), createBlock(Teleport, {
        ...
        default: withCtx(() => [createBaseVNode("div", {
          ...
          default: withCtx(() => [
            ...
            !isSingle.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("span", {
            ...
            createBaseVNode("div", { class: normalizeClass([unref(ns).e("btn"), unref(ns).e("actions")]) }, [createBaseVNode("div", { class: normalizeClass(unref(ns).e("actions__inner")) }, [renderSlot(_ctx.$slots, "toolbar", {
              ...
              createBaseVNode("i", { class: normalizeClass(unref(ns).e("actions__divider")) }, null, 2),
            ...
            createBaseVNode("div", { class: normalizeClass(unref(ns).e("canvas")) }, [loadError.value && _ctx.$slots["viewer-error"] ? renderSlot(_ctx.$slots, "viewer-error", {
              key: 0,
              activeIndex: activeIndex.value,
...
var image_vue_vue_type_script_setup_true_lang_default = defineComponent({
  name: "ElImage",
  inheritAttrs: false,
  __name: "image",
  props: imageProps,
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", mergeProps({
        ...
        onLoad: handleLoad,
        onError: handleError
      }), null, 16, _hoisted_12)) : createCommentVNode("v-if", true), isLoading.value ? (openBlock(), createElementBlock("div", {
        key: 1,
        class: normalizeClass(unref(ns).e("wrapper"))
      }, [renderSlot(_ctx.$slots, "placeholder", {}, () => [createBaseVNode("div", { class: normalizeClass(unref(ns).e("placeholder")) }, null, 2)])], 2)) : createCommentVNode("v-if", true)], 64)), preview.value ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [showViewer.value ? (openBlock(), createBlock(unref(ElImageViewer), {
        key: 0,
...
//# sourceMappingURL=element-plus_es_components_image_index__mjs.js.map
