...
function useOption(props, states) {
  ...
  const limitReached = computed(() => {
    if (select.props.multiple) {
      const modelValue = castArray_default(select.props.modelValue ?? []);
  ...
  watch(() => props.value, (val, oldVal) => {
    ...
    if (remote ? val !== oldVal : !isEqual_default(val, oldVal)) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }), [renderSlot(_ctx.$slots, "default", {}, () => [createBaseVNode("span", null, toDisplayString(_ctx.currentLabel), 1)])], 16, _hoisted_1)), [[vShow, _ctx.visible]]);
}
var option_default = _plugin_vue_export_helper_default(option_vue_vue_type_script_lang_default, [["render", _sfc_render]]);
...
var option_group_default = _plugin_vue_export_helper_default(option_group_vue_vue_type_script_lang_default, [["render", _sfc_render2]]);
...
var select_dropdown_default = _plugin_vue_export_helper_default(select_dropdown_vue_vue_type_script_lang_default, [["render", _sfc_render3]]);
...
var useSelect = (props, emit) => {
  ...
  const shouldShowPlaceholder = computed(() => {
    if (props.multiple && !isUndefined(props.modelValue)) return castArray_default(props.modelValue).length === 0 && !states.inputValue;
  ...
  watch(() => props.modelValue, (val, oldVal) => {
    ...
    setSelected();
    if (!isEqual_default(val, oldVal) && props.validateEvent) formItem == null ? void 0 : formItem.validate("change").catch(NOOP);
  }, {
    flush: "post",
    deep: true
  });
  ...
  const setSelected = () => {
    ...
    const result = [];
    if (!isUndefined(props.modelValue)) castArray_default(props.modelValue).forEach((value) => {
  ...
  const getOption = (value) => {
    ...
    const existingSelected = states.selected.find((item) => isObjectValue ? get_default(item.value, props.valueKey) === get_default(value, props.valueKey) : item.value === value);
    return {
      index: -1,
      value,
  ...
  const getLastNotDisabledIndex = (value) => findLastIndex_default(value, (it) => {
  ...
  const handleOptionSelect = (option) => {
    if (props.multiple) {
      ...
      !isEqual_default(props.modelValue, option.value) && emit("update:modelValue", option.value);
    ...
    default: withCtx(() => {
      ...
      return [createBaseVNode("div", {
        ...
        createBaseVNode("div", {
          ...
          }, null, 46, _hoisted_12), _ctx.filterable ? (openBlock(), createElementBlock("span", {
            key: 0,
            ref: "calculatorRef",
            "aria-hidden": "true",
          ...
          }, () => [createBaseVNode("span", null, toDisplayString(_ctx.currentPlaceholder), 1)]) : (openBlock(), createElementBlock("span", _hoisted_3, toDisplayString(_ctx.currentPlaceholder), 1))], 2)) : createCommentVNode("v-if", true)
        ], 2),
        createBaseVNode("div", {
          ref: "suffixRef",
...
var select_default = _plugin_vue_export_helper_default(select_vue_vue_type_script_lang_default, [["render", _sfc_render4]]);
...
//# sourceMappingURL=chunk-U5SF6KE3.js.map
