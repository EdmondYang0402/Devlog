...
import "./chunk-GUKQNH3A.js";
import {
  mutable
} from "./chunk-VHB577RR.js";
import "./chunk-3HFGK3DP.js";
import "./chunk-QLQF6BX6.js";
import {
  ElIcon
...
var prev_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var next_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", {
        ...
        disabled: unref(disabled)
      }, toDisplayString(unref(t)("el.pagination.total", { total: _ctx.total })), 11, _hoisted_14);
    };
  }
});
...
var _hoisted_23 = ["tabindex", "aria-label"];
var _hoisted_3 = [
  "aria-current",
  "aria-label",
  "tabindex"
...
var pager_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("ul", {
        ...
        }, " 1 ", 10, _hoisted_15)) : createCommentVNode("v-if", true),
        ...
        }, [(quickPrevHover.value || quickPrevFocus.value) && !_ctx.disabled ? (openBlock(), createBlock(unref(d_arrow_left_default), { key: 0 })) : (openBlock(), createBlock(unref(more_filled_default), { key: 1 }))], 42, _hoisted_23)) : createCommentVNode("v-if", true),
...
//# sourceMappingURL=element-plus_es_components_pagination_index__mjs.js.map
